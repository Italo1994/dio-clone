...
const Card = () => {
	return(
		<CardContainer>
			...
			<Content>
				<UserInfo>
					<UserPicture src="https://avatars.githubusercontent.com/u/26884429?s=400&u=a8870741f28af625c9dfa403960874ba26f83d15&v=4"/>
					<div>
						<h4>Italo Hortiz</h4>
						<p>Há 10 minutos</p>
					</div>
				...
				<PostInfo>
					...
					<p>Projeto realizado durante o curso de estilização com styled-components no bootcamp orange tech da dio...<strong>Saiba Mais</strong></p>
				</PostInfo>
				<HasInfo>
